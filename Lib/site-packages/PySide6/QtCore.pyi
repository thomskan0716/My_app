...
class QObject(Shiboken.Object):
    ...
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    @staticmethod
    def connect(sender: PySide6.QtCore.QObject, signal: bytes | bytearray | memoryview, context: PySide6.QtCore.QObject, functor: collections.abc.Callable[..., typing.Any], /, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    @staticmethod
    def connect(sender: PySide6.QtCore.QObject, signal: bytes | bytearray | memoryview, receiver: PySide6.QtCore.QObject, member: bytes | bytearray | memoryview, /, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    @staticmethod
    def connect(sender: PySide6.QtCore.QObject, signal: bytes | bytearray | memoryview, functor: collections.abc.Callable[..., typing.Any], /, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    def connect(self, sender: PySide6.QtCore.QObject, signal: bytes | bytearray | memoryview, member: bytes | bytearray | memoryview, /, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    def connect(self, signal: bytes | bytearray | memoryview, receiver: PySide6.QtCore.QObject, method: bytes | bytearray | memoryview, /, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    def connect(self, signal: bytes | bytearray | memoryview, functor: collections.abc.Callable[..., typing.Any], /, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...  # type: ignore[misc, overload-cannot-match]
    ...
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    @staticmethod
    def disconnect(sender: PySide6.QtCore.QObject, signal: bytes | bytearray | memoryview, receiver: PySide6.QtCore.QObject, member: bytes | bytearray | memoryview, /) -> bool: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    @staticmethod
    def disconnect(sender: PySide6.QtCore.QObject, signal: bytes | bytearray | memoryview, functor: collections.abc.Callable[..., typing.Any], /) -> bool: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    def disconnect(self, receiver: PySide6.QtCore.QObject, /, member: bytes | bytearray | memoryview | None = ...) -> bool: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    def disconnect(self, signal: bytes | bytearray | memoryview, receiver: PySide6.QtCore.QObject, member: bytes | bytearray | memoryview, /) -> bool: ...  # type: ignore[misc, overload-cannot-match]
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    def disconnect(self, signal: bytes | bytearray | memoryview, functor: collections.abc.Callable[..., typing.Any], /) -> bool: ...  # type: ignore[misc, overload-cannot-match]
