...
class QShortcut(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, key: PySide6.QtGui.QKeySequence, parent: PySide6.QtCore.QObject, callable: collections.abc.Callable[..., typing.Any], /, context: PySide6.QtCore.Qt.ShortcutContext = ..., *, enabled: bool | None = ..., autoRepeat: bool | None = ...) -> None: ...
    @typing.overload
