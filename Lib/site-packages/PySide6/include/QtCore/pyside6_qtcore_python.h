...
enum [[deprecated]] : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 924,
    ...
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 926,
    ...
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 928,
    SBK_QLOCALE_IDX                                          = 378,
    ...
    SBK_QMETACLASSINFO_IDX                                   = 418,
    SBK_QMETAENUM_IDX                                        = 420,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 424,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 426,
    SBK_QMETAMETHOD_IDX                                      = 422,
    SBK_QMETAOBJECT_CALL_IDX                                 = 430,
    SBK_QMETAOBJECT_IDX                                      = 428,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 432,
    SBK_QMETAPROPERTY_IDX                                    = 434,
    SBK_QMETATYPE_TYPE_IDX                                   = 438,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 440,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 250,
    SBK_QMETATYPE_IDX                                        = 436,
    SBK_QMICROPHONEPERMISSION_IDX                            = 442,
    SBK_QMIMEDATA_IDX                                        = 444,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 448,
    SBK_QMIMEDATABASE_IDX                                    = 446,
    SBK_QMIMETYPE_IDX                                        = 450,
    SBK_QMODELINDEX_IDX                                      = 452,
    SBK_QMODELROLEDATA_IDX                                   = 454,
    SBK_QMODELROLEDATASPAN_IDX                               = 456,
    SBK_QMUTEX_IDX                                           = 458,
    SBK_QNATIVEIPCKEY_TYPE_IDX                               = 462,
    SBK_QNATIVEIPCKEY_IDX                                    = 460,
    SBK_QOBJECT_IDX                                          = 464,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 468,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 466,
    SBK_QOPERATINGSYSTEMVERSIONBASE_IDX                      = 470,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 472,
    SBK_QPAUSEANIMATION_IDX                                  = 474,
    SBK_QPERMISSION_IDX                                      = 476,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 478,
    SBK_QPLUGINLOADER_IDX                                    = 480,
    SBK_QPOINT_IDX                                           = 482,
    SBK_QPOINTF_IDX                                          = 484,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 496,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 498,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 492,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 494,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 490,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 488,
    SBK_QPROCESS_IDX                                         = 486,
    SBK_QPROCESSENVIRONMENT_INITIALIZATION_IDX               = 502,
    SBK_QPROCESSENVIRONMENT_IDX                              = 500,
    SBK_QPROPERTYANIMATION_IDX                               = 504,
    SBK_QRANDOMGENERATOR_IDX                                 = 506,
    SBK_QRANDOMGENERATOR64_IDX                               = 508,
    SBK_QREADLOCKER_IDX                                      = 510,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 514,
    SBK_QREADWRITELOCK_IDX                                   = 512,
    SBK_QRECT_IDX                                            = 516,
    SBK_QRECTF_IDX                                           = 518,
    SBK_QRECURSIVEMUTEX_IDX                                  = 520,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 528,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 254,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 526,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 524,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 252,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 530,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 256,
    SBK_QREGULAREXPRESSION_IDX                               = 522,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 532,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 534,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 538,
    SBK_QRESOURCE_IDX                                        = 536,
    SBK_QRUNNABLE_IDX                                        = 540,
    SBK_QSAVEFILE_IDX                                        = 542,
    SBK_QSEMAPHORE_IDX                                       = 544,
    SBK_QSEMAPHORERELEASER_IDX                               = 546,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 548,
    SBK_QSETTINGS_STATUS_IDX                                 = 556,
    SBK_QSETTINGS_FORMAT_IDX                                 = 552,
    SBK_QSETTINGS_SCOPE_IDX                                  = 554,
    SBK_QSETTINGS_IDX                                        = 550,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 560,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 562,
    SBK_QSHAREDMEMORY_IDX                                    = 558,
    SBK_QSIGNALBLOCKER_IDX                                   = 564,
    SBK_QSIGNALMAPPER_IDX                                    = 566,
    SBK_QSIZE_IDX                                            = 568,
    SBK_QSIZEF_IDX                                           = 570,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 572,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 576,
    SBK_QSOCKETNOTIFIER_IDX                                  = 574,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 578,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 584,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 582,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 258,
    SBK_QSTANDARDPATHS_IDX                                   = 580,
    SBK_QSTORAGEINFO_IDX                                     = 586,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 590,
    SBK_QSTRINGCONVERTER_IDX                                 = 588,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 594,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 260,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 592,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 596,
    SBK_QSTRINGDECODER_IDX                                   = 598,
    SBK_QSTRINGENCODER_IDX                                   = 600,
    SBK_QSTRINGLISTMODEL_IDX                                 = 602,
    SBK_QSYSINFO_SIZES_IDX                                   = 608,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 606,
    SBK_QSYSINFO_IDX                                         = 604,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 612,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 614,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 610,
    SBK_QTEMPORARYDIR_IDX                                    = 616,
    SBK_QTEMPORARYFILE_IDX                                   = 618,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 624,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 622,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 262,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 620,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 632,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 628,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 634,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 630,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 264,
    SBK_QTEXTSTREAM_IDX                                      = 626,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 636,
    SBK_QTHREAD_PRIORITY_IDX                                 = 640,
    SBK_QTHREAD_QUALITYOFSERVICE_IDX                         = 642,
    SBK_QTHREAD_IDX                                          = 638,
    SBK_QTHREADPOOL_IDX                                      = 644,
    SBK_QTIME_IDX                                            = 646,
    SBK_QTIMELINE_STATE_IDX                                  = 652,
    SBK_QTIMELINE_DIRECTION_IDX                              = 650,
    SBK_QTIMELINE_IDX                                        = 648,
    SBK_QTIMEZONE_INITIALIZATION_IDX                         = 656,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 662,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 658,
    SBK_QTIMEZONE_IDX                                        = 654,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 660,
    SBK_QTIMER_IDX                                           = 664,
    SBK_QTIMEREVENT_IDX                                      = 666,
    SBK_QTRANSLATOR_IDX                                      = 668,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 670,
    SBK_QURL_PARSINGMODE_IDX                                 = 678,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 680,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 676,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 268,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 682,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 272,
    SBK_QURL_ACEPROCESSINGOPTION_IDX                         = 674,
    SBK_QFLAGS_QURL_ACEPROCESSINGOPTION_IDX                  = 266,
    SBK_QURL_IDX                                             = 672,
    SBK_QURLQUERY_IDX                                        = 684,
    SBK_QUUID_VARIANT_IDX                                    = 690,
    SBK_QUUID_VERSION_IDX                                    = 692,
    SBK_QUUID_STRINGFORMAT_IDX                               = 688,
    SBK_QUUID_IDX                                            = 686,
    SBK_QVARIANTANIMATION_IDX                                = 694,
    SBK_QVERSIONNUMBER_IDX                                   = 696,
    SBK_QWAITCONDITION_IDX                                   = 698,
    SBK_QWINEVENTNOTIFIER_IDX                                = 700,
    SBK_QWRITELOCKER_IDX                                     = 702,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 704,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 706,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 708,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 710,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 712,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 714,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 722,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 720,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 718,
    SBK_QXMLSTREAMREADER_IDX                                 = 716,
    SBK_QXMLSTREAMWRITER_IDX                                 = 724,
    SBK_QT_GLOBALCOLOR_IDX                                   = 798,
    SBK_QT_COLORSCHEME_IDX                                   = 754,
    SBK_QT_MOUSEBUTTON_IDX                                   = 830,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 300,
    SBK_QT_ORIENTATION_IDX                                   = 840,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 304,
    SBK_QT_FOCUSPOLICY_IDX                                   = 788,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 868,
    SBK_QT_SORTORDER_IDX                                     = 864,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 866,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 308,
    SBK_QT_TILERULE_IDX                                      = 878,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 728,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 274,
    SBK_QT_TEXTFLAG_IDX                                      = 872,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 870,
    SBK_QT_WHITESPACEMODE_IDX                                = 898,
    SBK_QT_HITTESTACCURACY_IDX                               = 802,
    SBK_QT_WINDOWTYPE_IDX                                    = 908,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 318,
    SBK_QT_WINDOWSTATE_IDX                                   = 906,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 316,
    SBK_QT_APPLICATIONSTATE_IDX                              = 734,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 276,
    SBK_QT_SCREENORIENTATION_IDX                             = 852,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 306,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 900,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 732,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 804,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 288,
    SBK_QT_BGMODE_IDX                                        = 742,
    SBK_QT_KEY_IDX                                           = 818,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 820,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 296,
    SBK_QT_MODIFIER_IDX                                      = 828,
    SBK_QT_ARROWTYPE_IDX                                     = 736,
    SBK_QT_PENSTYLE_IDX                                      = 846,
    SBK_QT_PENCAPSTYLE_IDX                                   = 842,
    SBK_QT_PENJOINSTYLE_IDX                                  = 844,
    SBK_QT_BRUSHSTYLE_IDX                                    = 744,
    SBK_QT_SIZEMODE_IDX                                      = 862,
    SBK_QT_UIEFFECT_IDX                                      = 896,
    SBK_QT_CURSORSHAPE_IDX                                   = 766,
    SBK_QT_TEXTFORMAT_IDX                                    = 874,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 738,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 772,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 278,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 774,
    SBK_QT_TOOLBARAREA_IDX                                   = 886,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 312,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 888,
    SBK_QT_DATEFORMAT_IDX                                    = 768,
    SBK_QT_TIMESPEC_IDX                                      = 880,
    SBK_QT_DAYOFWEEK_IDX                                     = 770,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 854,
    SBK_QT_CASESENSITIVITY_IDX                               = 746,
    SBK_QT_CORNER_IDX                                        = 764,
    SBK_QT_EDGE_IDX                                          = 778,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 282,
    SBK_QT_CONNECTIONTYPE_IDX                                = 756,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 858,
    SBK_QT_FILLRULE_IDX                                      = 784,
    SBK_QT_MASKMODE_IDX                                      = 824,
    SBK_QT_CLIPOPERATION_IDX                                 = 752,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 814,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 816,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 894,
    SBK_QT_AXIS_IDX                                          = 740,
    SBK_QT_FOCUSREASON_IDX                                   = 790,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 758,
    SBK_QT_CONTEXTMENUTRIGGER_IDX                            = 760,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 808,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 292,
    SBK_QT_INPUTMETHODHINT_IDX                               = 806,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 290,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 780,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 890,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 822,
    SBK_QT_ANCHORPOINT_IDX                                   = 730,
    SBK_QT_FINDCHILDOPTION_IDX                               = 786,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 284,
    SBK_QT_DROPACTION_IDX                                    = 776,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 280,
    SBK_QT_CHECKSTATE_IDX                                    = 748,
    SBK_QT_ITEMDATAROLE_IDX                                  = 810,
    SBK_QT_ITEMFLAG_IDX                                      = 812,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 294,
    SBK_QT_MATCHFLAG_IDX                                     = 826,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 298,
    SBK_QT_WINDOWMODALITY_IDX                                = 904,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 876,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 310,
    SBK_QT_EVENTPRIORITY_IDX                                 = 782,
    SBK_QT_SIZEHINT_IDX                                      = 860,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 902,
    SBK_QT_COORDINATESYSTEM_IDX                              = 762,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 892,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 314,
    SBK_QT_GESTURESTATE_IDX                                  = 794,
    SBK_QT_GESTURETYPE_IDX                                   = 796,
    SBK_QT_GESTUREFLAG_IDX                                   = 792,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 286,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 836,
    SBK_QT_NAVIGATIONMODE_IDX                                = 838,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 932,
    SBK_QT_TIMERTYPE_IDX                                     = 884,
    SBK_QT_TIMERID_IDX                                       = 882,
    SBK_QT_SCROLLPHASE_IDX                                   = 856,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 834,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 832,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 302,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 750,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 800,
    SBK_QT_PERMISSIONSTATUS_IDX                              = 848,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 850,
    SBK_QTCOREQT_IDX                                         = 726,
    SBK_QTCOREHELPER_QDIRLISTINGITERATOR_IDX                 = 912,
    SBK_QTCOREHELPER_QGENERICARGUMENTHOLDER_IDX              = 914,
    SBK_QTCOREHELPER_QGENERICRETURNARGUMENTHOLDER_IDX        = 916,
    SBK_QTCOREHELPER_QIOPIPE_IDX                             = 918,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 920,
    SBK_QCBORKNOWNTAGS_IDX                                   = 72,
    SBK_QCBORSIMPLETYPE_IDX                                  = 78,
    SBK_QCBORTAG_IDX                                         = 92,
    SBK_QTMSGTYPE_IDX                                        = 922,
    SBK_QTCORE_IDX_COUNT                                     = 934,
};
...
enum : int {
    ...
    SBK_QCoreApplication_ApplicationFlags_IDX                = 462,
    ...
    SBK_QLocale_CurrencySymbolFormat_IDX                     = 463,
    ...
    SBK_QLocale_QuotationStyle_IDX                           = 464,
    SBK_QLocale_IDX                                          = 189,
    ...
    SBK_QMetaClassInfo_IDX                                   = 209,
    SBK_QMetaEnum_IDX                                        = 210,
    SBK_QMetaMethod_Access_IDX                               = 212,
    SBK_QMetaMethod_MethodType_IDX                           = 213,
    SBK_QMetaMethod_IDX                                      = 211,
    SBK_QMetaObject_Call_IDX                                 = 215,
    SBK_QMetaObject_IDX                                      = 214,
    SBK_QMetaObject_Connection_IDX                           = 216,
    SBK_QMetaProperty_IDX                                    = 217,
    SBK_QMetaType_Type_IDX                                   = 219,
    SBK_QMetaType_TypeFlag_IDX                               = 220,
    SBK_QFlags_QMetaType_TypeFlag_IDX                        = 125,
    SBK_QMetaType_IDX                                        = 218,
    SBK_QMicrophonePermission_IDX                            = 221,
    SBK_QMimeData_IDX                                        = 222,
    SBK_QMimeDatabase_MatchMode_IDX                          = 224,
    SBK_QMimeDatabase_IDX                                    = 223,
    SBK_QMimeType_IDX                                        = 225,
    SBK_QModelIndex_IDX                                      = 226,
    SBK_QModelRoleData_IDX                                   = 227,
    SBK_QModelRoleDataSpan_IDX                               = 228,
    SBK_QMutex_IDX                                           = 229,
    SBK_QNativeIpcKey_Type_IDX                               = 231,
    SBK_QNativeIpcKey_IDX                                    = 230,
    SBK_QObject_IDX                                          = 232,
    SBK_QOperatingSystemVersion_OSType_IDX                   = 234,
    SBK_QOperatingSystemVersion_IDX                          = 233,
    SBK_QOperatingSystemVersionBase_IDX                      = 235,
    SBK_QParallelAnimationGroup_IDX                          = 236,
    SBK_QPauseAnimation_IDX                                  = 237,
    SBK_QPermission_IDX                                      = 238,
    SBK_QPersistentModelIndex_IDX                            = 239,
    SBK_QPluginLoader_IDX                                    = 240,
    SBK_QPoint_IDX                                           = 241,
    SBK_QPointF_IDX                                          = 242,
    SBK_QProcess_ProcessError_IDX                            = 248,
    SBK_QProcess_ProcessState_IDX                            = 249,
    SBK_QProcess_ProcessChannel_IDX                          = 246,
    SBK_QProcess_ProcessChannelMode_IDX                      = 247,
    SBK_QProcess_InputChannelMode_IDX                        = 245,
    SBK_QProcess_ExitStatus_IDX                              = 244,
    SBK_QProcess_IDX                                         = 243,
    SBK_QProcessEnvironment_Initialization_IDX               = 251,
    SBK_QProcessEnvironment_IDX                              = 250,
    SBK_QPropertyAnimation_IDX                               = 252,
    SBK_QRandomGenerator_IDX                                 = 253,
    SBK_QRandomGenerator64_IDX                               = 254,
    SBK_QReadLocker_IDX                                      = 255,
    SBK_QReadWriteLock_RecursionMode_IDX                     = 257,
    SBK_QReadWriteLock_IDX                                   = 256,
    SBK_QRect_IDX                                            = 258,
    SBK_QRectF_IDX                                           = 259,
    SBK_QRecursiveMutex_IDX                                  = 260,
    SBK_QRegularExpression_PatternOption_IDX                 = 264,
    SBK_QFlags_QRegularExpression_PatternOption_IDX          = 127,
    SBK_QRegularExpression_MatchType_IDX                     = 263,
    SBK_QRegularExpression_MatchOption_IDX                   = 262,
    SBK_QFlags_QRegularExpression_MatchOption_IDX            = 126,
    SBK_QRegularExpression_WildcardConversionOption_IDX      = 265,
    SBK_QFlags_QRegularExpression_WildcardConversionOption_IDX = 128,
    SBK_QRegularExpression_IDX                               = 261,
    SBK_QRegularExpressionMatch_IDX                          = 266,
    SBK_QRegularExpressionMatchIterator_IDX                  = 267,
    SBK_QResource_Compression_IDX                            = 269,
    SBK_QResource_IDX                                        = 268,
    SBK_QRunnable_IDX                                        = 270,
    SBK_QSaveFile_IDX                                        = 271,
    SBK_QSemaphore_IDX                                       = 272,
    SBK_QSemaphoreReleaser_IDX                               = 273,
    SBK_QSequentialAnimationGroup_IDX                        = 274,
    SBK_QSettings_Status_IDX                                 = 278,
    SBK_QSettings_Format_IDX                                 = 276,
    SBK_QSettings_Scope_IDX                                  = 277,
    SBK_QSettings_IDX                                        = 275,
    SBK_QSharedMemory_AccessMode_IDX                         = 280,
    SBK_QSharedMemory_SharedMemoryError_IDX                  = 281,
    SBK_QSharedMemory_IDX                                    = 279,
    SBK_QSignalBlocker_IDX                                   = 282,
    SBK_QSignalMapper_IDX                                    = 283,
    SBK_QSize_IDX                                            = 284,
    SBK_QSizeF_IDX                                           = 285,
    SBK_QSocketDescriptor_IDX                                = 286,
    SBK_QSocketNotifier_Type_IDX                             = 288,
    SBK_QSocketNotifier_IDX                                  = 287,
    SBK_QSortFilterProxyModel_IDX                            = 289,
    SBK_QStandardPaths_StandardLocation_IDX                  = 292,
    SBK_QStandardPaths_LocateOption_IDX                      = 291,
    SBK_QFlags_QStandardPaths_LocateOption_IDX               = 129,
    SBK_QStandardPaths_IDX                                   = 290,
    SBK_QStorageInfo_IDX                                     = 293,
    SBK_QStringConverter_Encoding_IDX                        = 295,
    SBK_QStringConverter_IDX                                 = 294,
    SBK_QStringConverterBase_Flag_IDX                        = 297,
    SBK_QFlags_QStringConverterBase_Flag_IDX                 = 130,
    SBK_QStringConverterBase_IDX                             = 296,
    SBK_QStringConverterBase_State_IDX                       = 298,
    SBK_QStringDecoder_IDX                                   = 299,
    SBK_QStringEncoder_IDX                                   = 300,
    SBK_QStringListModel_IDX                                 = 301,
    SBK_QSysInfo_Sizes_IDX                                   = 304,
    SBK_QSysInfo_Endian_IDX                                  = 303,
    SBK_QSysInfo_IDX                                         = 302,
    SBK_QSystemSemaphore_AccessMode_IDX                      = 306,
    SBK_QSystemSemaphore_SystemSemaphoreError_IDX            = 307,
    SBK_QSystemSemaphore_IDX                                 = 305,
    SBK_QTemporaryDir_IDX                                    = 308,
    SBK_QTemporaryFile_IDX                                   = 309,
    SBK_QTextBoundaryFinder_BoundaryType_IDX                 = 312,
    SBK_QTextBoundaryFinder_BoundaryReason_IDX               = 311,
    SBK_QFlags_QTextBoundaryFinder_BoundaryReason_IDX        = 131,
    SBK_QTextBoundaryFinder_IDX                              = 310,
    SBK_QTextStream_RealNumberNotation_IDX                   = 316,
    SBK_QTextStream_FieldAlignment_IDX                       = 314,
    SBK_QTextStream_Status_IDX                               = 317,
    SBK_QTextStream_NumberFlag_IDX                           = 315,
    SBK_QFlags_QTextStream_NumberFlag_IDX                    = 132,
    SBK_QTextStream_IDX                                      = 313,
    SBK_QTextStreamManipulator_IDX                           = 318,
    SBK_QThread_Priority_IDX                                 = 320,
    SBK_QThread_QualityOfService_IDX                         = 321,
    SBK_QThread_IDX                                          = 319,
    SBK_QThreadPool_IDX                                      = 322,
    SBK_QTime_IDX                                            = 323,
    SBK_QTimeLine_State_IDX                                  = 326,
    SBK_QTimeLine_Direction_IDX                              = 325,
    SBK_QTimeLine_IDX                                        = 324,
    SBK_QTimeZone_Initialization_IDX                         = 328,
    SBK_QTimeZone_TimeType_IDX                               = 331,
    SBK_QTimeZone_NameType_IDX                               = 329,
    SBK_QTimeZone_IDX                                        = 327,
    SBK_QTimeZone_OffsetData_IDX                             = 330,
    SBK_QTimer_IDX                                           = 332,
    SBK_QTimerEvent_IDX                                      = 333,
    SBK_QTranslator_IDX                                      = 334,
    SBK_QTransposeProxyModel_IDX                             = 335,
    SBK_QUrl_ParsingMode_IDX                                 = 339,
    SBK_QUrl_UrlFormattingOption_IDX                         = 340,
    SBK_QUrl_ComponentFormattingOption_IDX                   = 338,
    SBK_QFlags_QUrl_ComponentFormattingOption_IDX            = 134,
    SBK_QUrl_UserInputResolutionOption_IDX                   = 341,
    SBK_QFlags_QUrl_UserInputResolutionOption_IDX            = 136,
    SBK_QUrl_AceProcessingOption_IDX                         = 337,
    SBK_QFlags_QUrl_AceProcessingOption_IDX                  = 133,
    SBK_QUrl_IDX                                             = 336,
    SBK_QUrlQuery_IDX                                        = 342,
    SBK_QUuid_Variant_IDX                                    = 345,
    SBK_QUuid_Version_IDX                                    = 346,
    SBK_QUuid_StringFormat_IDX                               = 344,
    SBK_QUuid_IDX                                            = 343,
    SBK_QVariantAnimation_IDX                                = 347,
    SBK_QVersionNumber_IDX                                   = 348,
    SBK_QWaitCondition_IDX                                   = 349,
    SBK_QWinEventNotifier_IDX                                = 350,
    SBK_QWriteLocker_IDX                                     = 351,
    SBK_QXmlStreamAttribute_IDX                              = 352,
    SBK_QXmlStreamAttributes_IDX                             = 353,
    SBK_QXmlStreamEntityDeclaration_IDX                      = 354,
    SBK_QXmlStreamEntityResolver_IDX                         = 355,
    SBK_QXmlStreamNamespaceDeclaration_IDX                   = 356,
    SBK_QXmlStreamNotationDeclaration_IDX                    = 357,
    SBK_QXmlStreamReader_TokenType_IDX                       = 361,
    SBK_QXmlStreamReader_ReadElementTextBehaviour_IDX        = 360,
    SBK_QXmlStreamReader_Error_IDX                           = 359,
    SBK_QXmlStreamReader_IDX                                 = 358,
    SBK_QXmlStreamWriter_IDX                                 = 362,
    SBK_Qt_GlobalColor_IDX                                   = 399,
    SBK_Qt_ColorScheme_IDX                                   = 377,
    SBK_Qt_MouseButton_IDX                                   = 415,
    SBK_QFlags_Qt_MouseButton_IDX                            = 150,
    SBK_Qt_Orientation_IDX                                   = 420,
    SBK_QFlags_Qt_Orientation_IDX                            = 152,
    SBK_Qt_FocusPolicy_IDX                                   = 394,
    SBK_Qt_TabFocusBehavior_IDX                              = 434,
    SBK_Qt_SortOrder_IDX                                     = 432,
    SBK_Qt_SplitBehaviorFlags_IDX                            = 433,
    SBK_QFlags_Qt_SplitBehaviorFlags_IDX                     = 154,
    SBK_Qt_TileRule_IDX                                      = 439,
    SBK_Qt_AlignmentFlag_IDX                                 = 364,
    SBK_QFlags_Qt_AlignmentFlag_IDX                          = 137,
    SBK_Qt_TextFlag_IDX                                      = 436,
    SBK_Qt_TextElideMode_IDX                                 = 435,
    SBK_Qt_WhiteSpaceMode_IDX                                = 449,
    SBK_Qt_HitTestAccuracy_IDX                               = 401,
    SBK_Qt_WindowType_IDX                                    = 454,
    SBK_QFlags_Qt_WindowType_IDX                             = 159,
    SBK_Qt_WindowState_IDX                                   = 453,
    SBK_QFlags_Qt_WindowState_IDX                            = 158,
    SBK_Qt_ApplicationState_IDX                              = 367,
    SBK_QFlags_Qt_ApplicationState_IDX                       = 138,
    SBK_Qt_ScreenOrientation_IDX                             = 426,
    SBK_QFlags_Qt_ScreenOrientation_IDX                      = 153,
    SBK_Qt_WidgetAttribute_IDX                               = 450,
    SBK_Qt_ApplicationAttribute_IDX                          = 366,
    SBK_Qt_ImageConversionFlag_IDX                           = 402,
    SBK_QFlags_Qt_ImageConversionFlag_IDX                    = 144,
    SBK_Qt_BGMode_IDX                                        = 371,
    SBK_Qt_Key_IDX                                           = 409,
    SBK_Qt_KeyboardModifier_IDX                              = 410,
    SBK_QFlags_Qt_KeyboardModifier_IDX                       = 148,
    SBK_Qt_Modifier_IDX                                      = 414,
    SBK_Qt_ArrowType_IDX                                     = 368,
    SBK_Qt_PenStyle_IDX                                      = 423,
    SBK_Qt_PenCapStyle_IDX                                   = 421,
    SBK_Qt_PenJoinStyle_IDX                                  = 422,
    SBK_Qt_BrushStyle_IDX                                    = 372,
    SBK_Qt_SizeMode_IDX                                      = 431,
    SBK_Qt_UIEffect_IDX                                      = 448,
    SBK_Qt_CursorShape_IDX                                   = 383,
    SBK_Qt_TextFormat_IDX                                    = 437,
    SBK_Qt_AspectRatioMode_IDX                               = 369,
    SBK_Qt_DockWidgetArea_IDX                                = 386,
    SBK_QFlags_Qt_DockWidgetArea_IDX                         = 139,
    SBK_Qt_DockWidgetAreaSizes_IDX                           = 387,
    SBK_Qt_ToolBarArea_IDX                                   = 443,
    SBK_QFlags_Qt_ToolBarArea_IDX                            = 156,
    SBK_Qt_ToolBarAreaSizes_IDX                              = 444,
    SBK_Qt_DateFormat_IDX                                    = 384,
    SBK_Qt_TimeSpec_IDX                                      = 440,
    SBK_Qt_DayOfWeek_IDX                                     = 385,
    SBK_Qt_ScrollBarPolicy_IDX                               = 427,
    SBK_Qt_CaseSensitivity_IDX                               = 373,
    SBK_Qt_Corner_IDX                                        = 382,
    SBK_Qt_Edge_IDX                                          = 389,
    SBK_QFlags_Qt_Edge_IDX                                   = 141,
    SBK_Qt_ConnectionType_IDX                                = 378,
    SBK_Qt_ShortcutContext_IDX                               = 429,
    SBK_Qt_FillRule_IDX                                      = 392,
    SBK_Qt_MaskMode_IDX                                      = 412,
    SBK_Qt_ClipOperation_IDX                                 = 376,
    SBK_Qt_ItemSelectionMode_IDX                             = 407,
    SBK_Qt_ItemSelectionOperation_IDX                        = 408,
    SBK_Qt_TransformationMode_IDX                            = 447,
    SBK_Qt_Axis_IDX                                          = 370,
    SBK_Qt_FocusReason_IDX                                   = 395,
    SBK_Qt_ContextMenuPolicy_IDX                             = 379,
    SBK_Qt_ContextMenuTrigger_IDX                            = 380,
    SBK_Qt_InputMethodQuery_IDX                              = 404,
    SBK_QFlags_Qt_InputMethodQuery_IDX                       = 146,
    SBK_Qt_InputMethodHint_IDX                               = 403,
    SBK_QFlags_Qt_InputMethodHint_IDX                        = 145,
    SBK_Qt_EnterKeyType_IDX                                  = 390,
    SBK_Qt_ToolButtonStyle_IDX                               = 445,
    SBK_Qt_LayoutDirection_IDX                               = 411,
    SBK_Qt_AnchorPoint_IDX                                   = 365,
    SBK_Qt_FindChildOption_IDX                               = 393,
    SBK_QFlags_Qt_FindChildOption_IDX                        = 142,
    SBK_Qt_DropAction_IDX                                    = 388,
    SBK_QFlags_Qt_DropAction_IDX                             = 140,
    SBK_Qt_CheckState_IDX                                    = 374,
    SBK_Qt_ItemDataRole_IDX                                  = 405,
    SBK_Qt_ItemFlag_IDX                                      = 406,
    SBK_QFlags_Qt_ItemFlag_IDX                               = 147,
    SBK_Qt_MatchFlag_IDX                                     = 413,
    SBK_QFlags_Qt_MatchFlag_IDX                              = 149,
    SBK_Qt_WindowModality_IDX                                = 452,
    SBK_Qt_TextInteractionFlag_IDX                           = 438,
    SBK_QFlags_Qt_TextInteractionFlag_IDX                    = 155,
    SBK_Qt_EventPriority_IDX                                 = 391,
    SBK_Qt_SizeHint_IDX                                      = 430,
    SBK_Qt_WindowFrameSection_IDX                            = 451,
    SBK_Qt_CoordinateSystem_IDX                              = 381,
    SBK_Qt_TouchPointState_IDX                               = 446,
    SBK_QFlags_Qt_TouchPointState_IDX                        = 157,
    SBK_Qt_GestureState_IDX                                  = 397,
    SBK_Qt_GestureType_IDX                                   = 398,
    SBK_Qt_GestureFlag_IDX                                   = 396,
    SBK_QFlags_Qt_GestureFlag_IDX                            = 143,
    SBK_Qt_NativeGestureType_IDX                             = 418,
    SBK_Qt_NavigationMode_IDX                                = 419,
    SBK_Qt_CursorMoveStyle_IDX                               = 466,
    SBK_Qt_TimerType_IDX                                     = 442,
    SBK_Qt_TimerId_IDX                                       = 441,
    SBK_Qt_ScrollPhase_IDX                                   = 428,
    SBK_Qt_MouseEventSource_IDX                              = 417,
    SBK_Qt_MouseEventFlag_IDX                                = 416,
    SBK_QFlags_Qt_MouseEventFlag_IDX                         = 151,
    SBK_Qt_ChecksumType_IDX                                  = 375,
    SBK_Qt_HighDpiScaleFactorRoundingPolicy_IDX              = 400,
    SBK_Qt_PermissionStatus_IDX                              = 424,
    SBK_Qt_ReturnByValueConstant_IDX                         = 425,
    SBK_QtCoreQt_IDX                                         = 363,
    SBK_QtCoreHelper_QDirListingIterator_IDX                 = 456,
    SBK_QtCoreHelper_QGenericArgumentHolder_IDX              = 457,
    SBK_QtCoreHelper_QGenericReturnArgumentHolder_IDX        = 458,
    SBK_QtCoreHelper_QIOPipe_IDX                             = 459,
    SBK_QtCoreHelper_QMutexLocker_IDX                        = 460,
    SBK_QCborKnownTags_IDX                                   = 36,
    SBK_QCborSimpleType_IDX                                  = 39,
    SBK_QCborTag_IDX                                         = 46,
    SBK_QtMsgType_IDX                                        = 461,
    SBK_QtCore_IDX_COUNT                                     = 467,
};
